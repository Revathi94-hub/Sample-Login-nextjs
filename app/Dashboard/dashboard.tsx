...
const Dashboard = () => {
    ...
    const [animatedSection, setAnimatedSection] = useState<string | null>('home');
    ...
    const handleSectionClick = (sectionId: string) => {
      ...
      setTimeout(() => setAnimatedSection(sectionId), 0.5);
    };
  ...
  return (
    <div>
      <nav>
        <div className="flex flex-row items-center justify-between mx-4">
          ...
          <Link href="#home" className="text-xxl cursor-pointer text-blue-700" onClick={() => setAnimatedSection('home')}>Home</Link>
          <Link href="#location" className="text-xxl cursor-pointer text-blue-500" onClick={() => setAnimatedSection('location')}>Location</Link>
          <Link href="#demographics" className="text-xxl cursor-pointer text-blue-500" onClick={() => setAnimatedSection('demographics')}>Demographics</Link>
          <Link href="#history" className="text-xxl cursor-pointer text-blue-500" onClick={() => setAnimatedSection('history')}>History</Link>
      ...
      {/* Home page section */}
      <main id="home">
        <div className={animatedSection === 'home' ? 'animate-fade-in' : ''}>
          <h1 className="text-2xl font-bold p-2 text-center w-full">Welcome to Jayankondam</h1><br/>
      ...
      <main id="location">
        <div className={animatedSection === 'location' ? 'animate-fade-in' : ''}>
    ...
    <main id="demographics">
        <div className={animatedSection === 'demographics' ? 'animate-fade-in' : ''}>
      ...
      <main id="history">
        <div className={animatedSection === 'history' ? 'animate-fade-in' : ''}>
